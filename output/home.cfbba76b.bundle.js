	...
	_createClass(Index, [{
		...
		value: function render() {
			return React.createElement(
				...
				React.createElement(
					_navBar2.default,
					{ leftContent: '\u8FD4\u56DE2k4', mode: 'light', onLeftClick: function onLeftClick() {
				...
				React.createElement('img', { src: __webpack_require__(235), style: { width: '100%' } }),
				React.createElement(
					'div',
					{ className: 'bg-test' },
					'5\u53CD\u53CD\u590D\u590D4444444\u4ED8\u4ED8'
				...
				React.createElement(
					...
					{ to: 'list', style: { backgroundColor: '#fff', padding: '.1rem 0', display: 'block' } },
					'home/list\u9875\u9762'
				)
			);
		}
...
var RouteWithSubRoutes = function RouteWithSubRoutes(route) {
    return React.createElement(_reactRouterDom.Route, { path: route.path, render: function render(props) {
            return (
                // 把自路由向下传递来达到嵌套。
                React.createElement(route.component, _extends({}, props, { routes: route.routes }))
            );
        } });
};
    ...
    React.createElement(
        ...
        React.createElement(
            ...
            routes.map(function (route, i) {
                return React.createElement(RouteWithSubRoutes, _extends({ key: i }, route));
            })
        )
    )
...
module.exports = __webpack_require__.p + "images/83d17a29.1.png";
